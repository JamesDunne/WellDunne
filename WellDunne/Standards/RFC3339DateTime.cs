...
namespace System
{
    public struct RFC3339DateTime : IEquatable<RFC3339DateTime>, IComparable<RFC3339DateTime>
    {
        ...
        public RFC3339DateTime(DateTimeOffset date)
        {
            _value = date;
        }
        ...
        public static implicit operator RFC3339DateTime(DateTimeOffset date)
        {
            return new RFC3339DateTime(date);
        }

        public static implicit operator DateTimeOffset(RFC3339DateTime date)
        {
            return date._value;
        }
